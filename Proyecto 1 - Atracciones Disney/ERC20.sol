...
interface IERC20{
    ...
    //Función transferencia desde una cuenta específica de un cliente hacia otra
...
contract ERC20Basic is IERC20{
    ...
    uint8 public constant decimals = 2; //Modified to "2" to have less decimals than 18 (standard)
    ...
    constructor (uint256 initialSupply, string memory _name, string memory _symbol) public{
